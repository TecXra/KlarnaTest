...
<div class="productFilter productFilterLook2">
    <div id="productType" data-toggle="buttons">
        <div class="row"> 
            <div class="col-sm-12"> 
                <button id="selectComplete" class="btn btn-default" type="button"  data-type="kompletta-hjul/falgar"> Kompletta Hjul <span class="glyphicon glyphicon-ok" aria-hidden="true" style="visibility:visible;"></span>
                </button>
            </div>  
        </div> 
        <div class="row"> 
