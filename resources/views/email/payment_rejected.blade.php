            ...
            <div class="statusContent">
                    ...
                    <div class="col-sm-12">
                        <div class=" statusTop">
                            ...
                            <p><strong>Status: <span style="background-color: #d9534f; color: #fff; padding: 5px;">Avslag</span></strong></p>
                    ...
                    <p>
						Vi beklagar men er order {{$order->id}} har ej gått igenom. Det kan finnas flera anledningar till varför en order nekas. Vill du komma i kontakt med Svea, så har du kontaktuppgifterna här: 08-514 931 13. Ange Sveas följande errorkod för snabb handledning med Svea: {{$resultCode}}
                    </p>

                    <br>
                    <p>
                    	Vid nekad kredit kan du välja att betala mot Plusgiro: 660784-0, Bankgiro: 140-6586 eller direkt kortbetalning i kassan. Denna information har även skickats till angiven E-post adress.
                    </p>
