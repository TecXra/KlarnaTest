            ...
            <div class="statusContent">
                    ...
                    <div class="col-sm-12">
                        <div class=" statusTop">
                            ...
                            <p><strong>Status: <span style="background-color: #2D5E96; color: #fff; padding: 5px;">Ny order</span></strong></p>
                            <p style="color: #D74D42">Preliminärt är det  {{ $order->delivery_time }} på dina varor</p>
                        </div>
                    </div>
                    <br>
                    {{-- <div class="left">
        ...
        <!--/row end-->
        	<div class="thanxContent">
	            ...
	            <p>
	                ...
	                <br>
					@if($password)
						Användarnamn: {{ $order->user->email}} <br>
						Lösenord: {{$password}}
					@endif
				</p>
