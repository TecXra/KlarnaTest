            ...
            <div class="statusContent">
                    ...
                    <div class="col-sm-12">
                        <div class=" statusTop">
                            ...
                            <p><strong>Status: <span style="background-color: #5cb85c; color: #fff; padding: 5px;">Skickat</span></strong></p>
                            <p>
                            	<b>Kommenter: </b> {{ $order->comment }}
                            </p>
