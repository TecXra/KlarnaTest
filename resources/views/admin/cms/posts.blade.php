...
@include('admin/cms/partials/form/create_post_modal')
@include('admin/cms/partials/form/update_post_modal') 
...
<div class="container" style="margin-top: 150px;margin-bottom: 100px">
    <div class="row">
        ...
        <div class="col-sm-10" style="border-left: 1px solid #ddd; padding-left:30px">
        	...
        	<div class="row">
        		<div class="col-sm-12">
        			<h1 class="pull-left">Hantera inlägg</h1>
        			<button class="btn btn-default pull-right" data-toggle="modal" data-target="#createPostModal">Skapa ny</button>
        		</div>
        	</div>
        	...
        	<div class="row">
        		...
        		<div id="dataTable" class="col-sm-12">
        			@include('admin/cms/partials/table/posts_table')
        	    </div>
        	</div>
...
<script type="text/javascript">
    ...
    $(document).on('submit', '#createPostForm', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
               ...
               if(data.status) {
                     window.location.href = '{{ url('admin/cms/inlagg/') }}';
    ...
    $(document).on('click', '#edit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#EditInputPostName').val(data.post.name);
                $('#EditInputPostLabel').val(data.post.label);
                $('#EditInputAuthor').val(data.post.author);
                $('#EditInputMetaTitle').val(data.post.meta_title);
                $('#EditInputMetaDescription').val(data.post.meta_description);
                $('#EditInputMetaKeywords').val(data.post.meta_keywords);
    ...
    $(document).on('change', '#DDPageID2', function() {
        var postId = $(this).data('id');
        var DDPageID2 = $(this).val();
        $('#userUpdateMessage').empty();
