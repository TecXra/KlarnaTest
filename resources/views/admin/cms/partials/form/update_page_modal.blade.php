<div class="modal cmsForm fade" id="updatePageModal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
	            ...
	            <div class="row userInfo">
	                ...
	                <form {{-- action="storeUser" method="POST" --}} id="updatePageForm" style="padding:15px">
	                	{{ csrf_field() }}
		                <div class="row">
		                    <div class="col-sm-12">
                    	...
                    	<div class="row">
	                        ...
	                        <div class="col-sm-6 form-group required">
	                            ...
	                            <input required type="text" class="form-control" id="EditInputPageLabel" name="EditInputPageLabel">
	                        </div>

	                        <div class="col-sm-6 form-group required">
	                            <label>url<sup>*</sup></label>
	                            <input required type="text" class="form-control" id="EditInputPageName" name="EditInputPageName">
	                        </div>
	                    ...
	                    <div class="row">
		                    <div class="col-sm-12">
		                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> &nbsp; Uppdatera sida</button>
		                    </div>
		                </div>
