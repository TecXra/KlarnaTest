<div class="modal cmsForm fade" id="createPostModal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
	            ...
	            <div class="row userInfo">
	                ...
	                <form {{-- action="storeUser" method="POST" --}} id="createPostForm" style="padding:15px">
	                	{{ csrf_field() }}
                    	...
                    	<div class="row">
	                        ...
	                        <div class="col-sm-6 form-group required">
	                            ...
	                            <input required type="text" class="form-control" id="InputPostLabel" name="InputPostLabel">
	                        </div>

	                        <div class="col-sm-6 form-group required">
	                            <label>url<sup>*</sup></label>
	                            <input required type="text" class="form-control" id="InputPostName" name="InputPostName">
	                        </div>
	                    ...
	                    <div class="row">
							<div class="col-sm-12 form-group required">
	                            ...
	                            <input required type="text" class="form-control" id="InputAuthor" name="InputAuthor">
	                        </div>
	                    </div>
						...
						<div class="row">
		                    <div class="col-sm-12">
		                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> &nbsp; Skapa inlägg</button>
		                    </div>
		                </div>
