                ...
                <div class="item col-xs-6 col-sm-4 col-md-2">
                    <div class="product">
                        <div class="image">
                            ...
                            @elseif($item->productType->name == 'falgar')
                                <img height=150 src="{{ asset('images/product/noRimImg.jpg') }}" alt="{{ $item->product_brand }} {{ $item->product_model }}">
                            @else
                                <img height=150 src="{{ asset('images/product/noImg.jpg') }}" alt="{{ $item->product_brand }} {{ $item->product_model }}">
                            @endif
                            </a>
                        ...
                        @if(isset($rim_dimension_search))
                            <h4><a href="{{ url($item->productUrl() . '/pcd/') }}">{{ $item->product_name }} </a></h4>
                        @else
